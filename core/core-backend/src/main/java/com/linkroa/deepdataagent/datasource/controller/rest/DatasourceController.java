...
public class DatasourceController {
    ...
    public ApiResponse<String> sync(@Valid @RequestBody IdRequest request) {
        applicationService.syncMetadata(request.id());
    ...
    public ApiResponse<PaginatedResponse<TableResponse>> tableList(@Valid @RequestBody ListTablesRequest request) {
    ...
    @PostMapping("/api-schema/update")
    public ApiResponse<String> updateApiSchema(@Valid @RequestBody UpdateApiSchemaRequest request) {
        applicationService.updateApiSchema(request.schemaId(), request);
        return ApiResponse.success("更新API表成功");
    }

    @PostMapping("/api-schema/delete")
    public ApiResponse<String> deleteApiSchema(@Valid @RequestBody IdRequest request) {
        applicationService.deleteApiSchema(request.id());
        return ApiResponse.success("删除API表成功");
    }

    @PostMapping("/api-schema/detail")
    public ApiResponse<ApiSchemaDetailResponse> getApiSchema(@Valid @RequestBody IdRequest request) {
        ApiSchemaDetailResponse response = applicationService.getApiSchemaDetail(request.id());
        return ApiResponse.success(response);
    }

    @PostMapping("/api/test-pre-operation")
    public ApiResponse<Map<String, Object>> testPreOperation(@Valid @RequestBody TestPreOperationRequest request) {
        Map<String, Object> result = applicationService.testPreOperation(request);
        return ApiResponse.success(result);
    }
