...
public class TextToSqlService {
    ...
    public String convert(Long modelConfigId, String userQuestion, String schemaInfo, String sqlDialect) {
        return convert(modelConfigId, userQuestion, schemaInfo, sqlDialect, null);
    }
     ...
     * @throws DeepDataAgentException 如果转换失败
     */
    public String convert(Long modelConfigId, String userQuestion, String schemaInfo, String sqlDialect, String sessionId) {
