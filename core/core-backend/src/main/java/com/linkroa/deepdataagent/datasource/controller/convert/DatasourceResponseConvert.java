package com.linkroa.deepdataagent.datasource.controller.convert;

import com.linkroa.deepdataagent.datasource.controller.response.ApiAuthConfigResponse;
import com.linkroa.deepdataagent.datasource.controller.response.ApiFieldResponse;
import com.linkroa.deepdataagent.datasource.controller.response.ApiPaginationConfigResponse;
import com.linkroa.deepdataagent.datasource.controller.response.ApiSchemaDetailResponse;
import com.linkroa.deepdataagent.datasource.controller.response.ColumnInfoResponse;
import com.linkroa.deepdataagent.datasource.controller.response.DatasourceConnectionResponse;
import com.linkroa.deepdataagent.datasource.controller.response.ParamMappingResponse;
import com.linkroa.deepdataagent.datasource.controller.response.PreOperationConfigResponse;
import com.linkroa.deepdataagent.datasource.controller.response.TableInfoResponse;
import com.linkroa.deepdataagent.datasource.controller.response.TableResponse;
...
public interface DatasourceResponseConvert {

    DatasourceResponseConvert INSTANCE = Mappers.getMapper(DatasourceResponseConvert.class);
