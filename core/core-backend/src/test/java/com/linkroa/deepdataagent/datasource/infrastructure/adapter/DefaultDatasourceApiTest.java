...
/**
 * {@link DefaultDatasourceApi} 数据源查询服务契约单测（只读查询，mock 仓储/策略）。
 */
@ExtendWith(MockitoExtension.class)
class DefaultDatasourceApiTest {
    ...
    @InjectMocks
    private DefaultDatasourceApi api;
    ...
    void should_returnRefs_when_listDatasources_given_existingIds() {
        ...
        // when
        List<DatasourceReferenceDTO> refs = api.listDatasources(List.of(1L));
    ...
    void should_listJdbcTableNames_when_listTableNames_given_jdbcConnection() {
        ...
        // when
        List<String> tables = api.listTableNames(1L);
    ...
    void should_previewJdbcTable_when_previewTable_given_enabledConnection() {
        ...
        // when
        DatasourcePreviewDTO preview = api.previewTable(1L, "orders", 10);
