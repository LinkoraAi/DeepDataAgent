...
class SkillCommandConvertTest {
    ...
    void should_mapSkillFields_when_toCreateCommand_given_typeCodeAndContent() {
        ...
        // when
        CreateSkillCommand command = SkillCommandConvert.INSTANCE.toCreateCommand(request, content);
    ...
    void should_defaultToCustomType_when_toCreateCommand_given_nullSkillType() {
        ...
        // when
        CreateSkillCommand command = SkillCommandConvert.INSTANCE.toCreateCommand(request, new byte[]{1});
    ...
    void should_mapPublishFields_when_toPublishCommand_given_versionRequestAndContent() {
        ...
        // when
        PublishSkillVersionCommand command = SkillCommandConvert.INSTANCE.toPublishCommand("skill-1", request, content);
