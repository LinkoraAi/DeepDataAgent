package com.linkroa.deepdataagent.datasource.infrastructure.convert;
...
class DatasourcePersistenceConvertTest {

    private DatasourcePersistenceConvert persistenceMapper;
    ...
    void setUp() {
        ...
        persistenceMapper = DatasourcePersistenceConvert.INSTANCE;
    }
