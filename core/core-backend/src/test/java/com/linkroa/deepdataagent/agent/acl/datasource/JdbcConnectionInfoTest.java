...
class JdbcConnectionInfoTest {
    ...
    void create_shouldSucceed_whenValid() {
        JdbcConnectionInfo info = new JdbcConnectionInfo("localhost", 3306, "testdb", "user", "pass");
    ...
    void create_shouldThrow_whenHostIsNull() {
        assertThrows(IllegalArgumentException.class, () ->
                new JdbcConnectionInfo(null, 3306, "testdb", "user", "pass")
        );
    }
    ...
    void create_shouldThrow_whenHostIsBlank() {
        assertThrows(IllegalArgumentException.class, () ->
                new JdbcConnectionInfo("   ", 3306, "testdb", "user", "pass")
        );
    }
    ...
    void create_shouldThrow_whenPortIsZero() {
        assertThrows(IllegalArgumentException.class, () ->
                new JdbcConnectionInfo("localhost", 0, "testdb", "user", "pass")
        );
    }
    ...
    void create_shouldThrow_whenPortIsNegative() {
        assertThrows(IllegalArgumentException.class, () ->
                new JdbcConnectionInfo("localhost", -1, "testdb", "user", "pass")
        );
    }
    ...
    void create_shouldThrow_whenDatabaseIsNull() {
        assertThrows(IllegalArgumentException.class, () ->
                new JdbcConnectionInfo("localhost", 3306, null, "user", "pass")
        );
    }
    ...
    void create_shouldThrow_whenDatabaseIsBlank() {
        assertThrows(IllegalArgumentException.class, () ->
                new JdbcConnectionInfo("localhost", 3306, "   ", "user", "pass")
        );
    }
}
